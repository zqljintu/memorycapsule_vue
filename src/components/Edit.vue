<template>
	<div>
		<mt-header class="add_mc" id="add_mc" fixed title="修改">
	...
	export default {
		...
		methods:{
			...
			submit:function(event){
				...
				this.$http.post(this.utils.getUrl() + '/api/edit_capsule', formData)
		      	.then((response) => {
			...
			initDefaultData: function(item){
				this.capsule_pk = item.pk
				this.capsule_type = item.fields.capsule_type
				this.capsule_content = item.fields.capsule_content
				this.capsule_time = item.fields.capsule_time
				this.capsule_date = item.fields.capsule_date
				this.capsule_person = item.fields.capsule_person
				this.capsule_location = item.fields.capsule_location
				this.capsule_image = item.fields.capsule_image
		...
		mounted:function(){
			...
			if(this.islogin){
				...
				this.initDefaultData(this.$store.getters.getCapsuleitem)
